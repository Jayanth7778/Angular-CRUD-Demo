...
public class PersonController
{
	...
	public ResponseEntity<?> getPerson(@PathVariable int id)
	{
		...
		if(person==null)
		{
			ErrorClazz error=new ErrorClazz(1,"Person with id " + id+ " doesn't exists");
			return new ResponseEntity<ErrorClazz>(error,HttpStatus.NOT_FOUND);//404
		}
	...
	public ResponseEntity<?> updatePerson(@RequestBody Person person)
	{
		...
		{
			ErrorClazz error=new ErrorClazz(2,"Unable to update person details");
